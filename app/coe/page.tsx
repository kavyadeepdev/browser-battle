  ...
  return (
    <main className="min-h-screen bg-cream selection:bg-gold selection:text-navy">
      ...
      <section className="relative pt-32 pb-20 bg-navy-deep overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://picsum.photos/seed/coe/1920/1080')] bg-cover bg-center opacity-10 mix-blend-overlay"></div>
        ...
        <div className="relative z-20 max-w-[1280px] mx-auto px-6">
          ...
          <h1 className="font-serif font-black text-cream text-4xl md:text-6xl mb-6 tracking-tighter">
